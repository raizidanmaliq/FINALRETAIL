    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Banner Promo</li>
            </ol>
        </div>
    </div>
</header>
...
<section class="card">
    <article class="card-header">
        <div class="float-right">
            <div class="btn-group">
                <a href="{{ route('admin.cms.banners.create') }}" class="btn text-white" style="background-color: #9B4141;"><i class="fa fa-plus"></i> Tambah Banner</a>
            </div>
        </div>
    </article>
    ...
    $(function() {
        $('#datatable').DataTable({
            ...
            ajax: {
                ...
                url: "{{ route('admin.cms.banners.data') }}",
                dataType: "json",
                type: "POST"
            },
            columns: [
