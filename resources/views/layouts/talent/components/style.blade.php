...
<link rel="icon" type="image/x-icon" href="{{ asset('back_assets/dist/img/public/logo.png') }}" />
<!-- Tempusdominus Bbootstrap 4 -->
<link rel="stylesheet" href="{{ asset('/back_assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
<!-- iCheck -->
...
<link rel="stylesheet" href="{{ asset('/back_assets/dist/css/styles.css') }}">
<!-- overlayScrollbars -->
...
<!-- summernote -->
<link rel="stylesheet" href="{{ asset('/back_assets/plugins/summernote/summernote-bs4.css') }}">
...
<style>
  .sidebar-dark-secondary .nav-sidebar>.nav-item>.nav-link.active, .sidebar-light-secondary .nav-sidebar>.nav-item>.nav-link.active {
    background-color: #ba925e !important;
    color: #fff;
  }
